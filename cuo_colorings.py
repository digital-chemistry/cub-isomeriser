...
_VERTEX_LABELS = {'a1b1':1, 'a1b2':3, 'a2b1':9, 'a2b2':11,
                  'a1c1':2,'a1c2':4,'a2c1':10,'a2c2':12,
                  'b1c1':5,'b1c2':8, 'b2c1':6, 'b2c2':7}
"""
2(1,9)  # 485
2(1,8) # 343
2(1,7) # 686
...
[('a1b1', '0'), ('a1b2', '0')]  #  2(1,9)  # 485
[('a1b1', '0'), ('a1c1', '0')]  #  2(1,8) # 343
[('a1b1', '0'), ('a2b2', '0')]  #  2(1,7) # 686
[('a1b1', '0'), ('a2c1', '0')]  #  2(1,7) # 594
[('a1b1', '0'), ('a2c2', '0')]  #  2(1,10) # 594
"""
...
def distance_between_two_vertices(v0, v1):
    ...
    if len(v0) == 4 and len(v1) == 4:
            ...
            if v0[0] == v1[0] and v0[2] == v1[2] and (v0[1] == v1[1] or v0[3] == v1[3]):
                ...
                assert not(v0[1] == v1[1] and v0[3] == v1[3]), '{} {}'.format(
                    v0, v1)
                return 686
...
def cuo_colorings():
    ...
    for zeros in range(0, 13): 
        ...
        file_name = 'cuo_{}zeros_{}.txt'.format(zeros, len(unique_colorings))
